...
| recursive LU (runner-tuned) is the fastest wasm LU measured: beats scipy at n ≤ 128 (1.1–1.5×), reaches parity at 256, 0.8× at 512; 24% over the blocked driver at 256 | observed | scripted | Run 5 (29045340390) same-run three-way; knobs swept on the runner (`lu-tune.yml`) and gated (`gate.mjs` recursive ≤ blocked ≤ faer-tuned) |
