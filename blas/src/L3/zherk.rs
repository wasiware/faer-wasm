//! `zherk` — Hermitian rank-k update: C ← αAAᴴ + βC, α and β REAL,
//! one triangle of C stored.
//!
//! Implementation: the `dsyrk` shape — truncated column-zaxpy,
...
//! reference `zherk`'s DBLE() convention (the products' imaginary
