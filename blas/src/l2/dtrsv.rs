//! `dtrsv` — triangular solve, one right-hand side, in place: x ← A⁻¹x.
//!
//! Implementation: divide-then-column-daxpy, 4-column fan-in (tuned
...
//! pass (`kernels::daxpy4in`, sources in the same step order), cutting
...
pub fn dtrsv(n: usize, a: &[f64], cs: usize, upper: bool, unit: bool, x: &mut [f64]) {
